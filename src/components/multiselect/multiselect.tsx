        ...
        <PopoverTrigger asChild>
          <FormControl>
            <Button
              ...
              role="combobox"
              className={cn(
                "mt-[6px] py-1.5  h-max max-w-full justify-between shadow:none border-purple-100 focus-visible:ring-purple-500 focus:outline-purple-500 z-0 hover:bg-purple-0 flex-grow-0"
              )}
            >
